...
<html prefix="og: http://ogp.me/ns#" lang="en-GB" dir="ltr">
	<head>
		<title>Search - OZIMAP</title>
		<meta charset="utf-8" />
		<!--[if IE]><meta http-equiv="ImageToolbar" content="False" /><![endif]-->
		<meta name="author" content="Radu PREDESCU" />
		<meta name="generator" content="Incomedia WebSite X5 Professional 14.0.6.2 - www.websitex5.com" />
		<meta property="og:locale" content="en" />
		<meta property="og:type" content="website" />
		<meta property="og:url" content="http://ozimap.com/imsearch.php" />
		<meta property="og:title" content="Search" />
		<meta property="og:site_name" content="OZIMAP" />
		<meta property="og:image" content="http://ozimap.com/favImage.png" />
		...
		<link rel="stylesheet" type="text/css" href="pcss/imsearch.css?14-0-6-2-637555990848205812" media="screen,print" />
		...
		<link rel="icon" href="favicon.png?14-0-6-2-637555990848138855" type="image/png" />
	</head>
	<body>
		<div id="imPageExtContainer">
			<div id="imPageIntContainer">
				...
				<div id="imPage">
					<div id="imHeader">
						<h1 class="imHidden">Search - OZIMAP</h1>
        ...
        </div></div></div></div><div id="imHeader_imTextObject_03_wrapper" class="template-object-wrapper"><div id="imHeader_imCell_3" class="" > <div id="imHeader_imCellStyleGraphics_3"></div><div id="imHeader_imCellStyle_3" ><div id="imHeader_imTextObject_03">
	<div class="text-tab-content"  id="imHeader_imTextObject_03_tab0" style="">
		<div class="text-inner">
			<span class="fs9 cf1"><b>FOLLOW US</b></span>
		</div>
	</div>
...
GALERIE		</a>
	...
	</li><li class="imMnMnMiddle imPage" data-link-paths="/locatie.html">
<div class="label-wrapper">
<div class="label-inner-wrapper">
		<a class="label" href="locatie.html">
LOCATIE		</a>
</div>
</div>
	</li><li class="imMnMnMiddle imPage" data-link-paths="/planuri-si-preturi.html">
<div class="label-wrapper">
<div class="label-inner-wrapper">
		<a class="label" href="planuri-si-preturi.html">
PLANURI SI PRETURI		</a>
</div>
</div>
	</li><li class="imMnMnLast imPage" data-link-paths="/elev.html">
<div class="label-wrapper">
<div class="label-inner-wrapper">
		<a class="label" href="elev.html">
ELEV		</a>
</div>
</div>
...
$(function () {$('#imHeader_imMenuObject_09 ul li').each(function () {    var $this = $(this), timeout = 0;    $this.on('mouseenter', function () {        if($(this).parents('#imHeader_imMenuObject_09-menu-opened').length > 0) return;         clearTimeout(timeout);        setTimeout(function () { $this.children('ul, .multiple-column').stop(false, false).fadeIn(); }, 250);    }).on('mouseleave', function () {        if($(this).parents('#imHeader_imMenuObject_09-menu-opened').length > 0) return;         timeout = setTimeout(function () { $this.children('ul, .multiple-column').stop(false, false).fadeOut(); }, 250);    });});});
	...
	<div class="text-tab-content"  id="imHeader_imTextObject_10_tab0" style="">
		<div class="text-inner">
			<span class="fs36 cf1 ff1">OZIMAP PCS GROUP</span><div><br></div>
		</div>
	</div>
	...
	<div class="text-tab-content"  id="imHeader_imTextObject_11_tab0" style="">
		<div class="text-inner">
			<div style="text-align: center;"><span class="fs20 cf1 ff1"><b>Un nou complex rezidential in orasul tau!</b></span></div>
		</div>
	</div>
	...
	<div class="text-tab-content"  id="imHeader_imTextObject_12_tab0" style="">
		<div class="text-inner">
			<div><span class="fs26 cf1 ff1"><i>~Nu doar o casa...Va oferim ACASA!~</i></span></div>
		</div>
	</div>
...
$(function () {$('#imStickyBar_imMenuObject_01 ul li').each(function () {    var $this = $(this), timeout = 0;    $this.on('mouseenter', function () {        if($(this).parents('#imStickyBar_imMenuObject_01-menu-opened').length > 0) return;         clearTimeout(timeout);        setTimeout(function () { $this.children('ul, .multiple-column').stop(false, false).fadeIn(); }, 250);    }).on('mouseleave', function () {        if($(this).parents('#imStickyBar_imMenuObject_01-menu-opened').length > 0) return;         timeout = setTimeout(function () { $this.children('ul, .multiple-column').stop(false, false).fadeOut(); }, 250);    });});});
...
</div></div></div><div id="imStickyBar_imObjectTitle_02_wrapper" class="template-object-wrapper"><div id="imStickyBar_imCell_2" class="" > <div id="imStickyBar_imCellStyleGraphics_2"></div><div id="imStickyBar_imCellStyle_2" ><div id="imStickyBar_imObjectTitle_02"><span id ="imStickyBar_imObjectTitle_02_text" >MENU</span > </div></div></div></div></div>
						</div>
					</div>
	...
	<div class="text-tab-content"  id="imFooter_imTextObject_04_tab0" style="">
		<div class="text-inner">
			<b class="fs16 cf1 ff1">WEBSITE MAP</b><div><b><span class="cf1"><a href="index.html" class="imCssLink" onclick="return x5engine.utils.location('index.html', null, false)">HOME</a></span></b></div><div><b><span class="cf1"><a href="galerie.html" class="imCssLink" onclick="return x5engine.utils.location('galerie.html', null, false)">GALERIE</a></span></b></div><div><span class="cf1"><a href="locatie.html" class="imCssLink" onclick="return x5engine.utils.location('locatie.html', null, false)">LOCATIE</a></span></div><div><span class="cf1"><a href="planuri-si-preturi.html" class="imCssLink" onclick="return x5engine.utils.location('planuri-si-preturi.html', null, false)">PLANURI</a></span></div><div><span class="cf1"><a href="elev.html" class="imCssLink" onclick="return x5engine.utils.location('elev.html', null, false)">ELEV</a></span></div>
		</div>
	</div>
	...
	<div class="text-tab-content"  id="imFooter_imTextObject_08_tab0" style="">
		<div class="text-inner">
			<div style="text-align: right;"><b class="fs14 cf1">CONTACT</b></div><div style="text-align: right;"><span class="fs14 cf1">TARGU JIU</span></div><div style="text-align: right;"><span class="fs14 cf1">GORJ</span></div><div style="text-align: right;"><span class="fs14 cf1">ROMANIA</span></div><div style="text-align: right;"><div><span class="fs14 cf1">+4 0721 955 894</span></div><div><span class="fs14 cf1">ozimap@yahoo.com</span></div></div>
		</div>
	</div>

</div>
</div></div></div><div id="imFooter_imObjectImage_09_wrapper" class="template-object-wrapper"><div id="imFooter_imCell_9" class="" > <div id="imFooter_imCellStyleGraphics_9"></div><div id="imFooter_imCellStyle_9" ><img id="imFooter_imObjectImage_09" src="images/line_hor-1-.png" title="" alt="" /></div></div></div><div id="imFooter_imObjectImage_10_wrapper" class="template-object-wrapper"><div id="imFooter_imCell_10" class="" > <div id="imFooter_imCellStyleGraphics_10"></div><div id="imFooter_imCellStyle_10" ><img id="imFooter_imObjectImage_10" src="images/icon.png" title="" alt="" /></div></div></div><div id="imFooter_imTextObject_11_wrapper" class="template-object-wrapper"><div id="imFooter_imCell_11" class="" > <div id="imFooter_imCellStyleGraphics_11"></div><div id="imFooter_imCellStyle_11" ><div id="imFooter_imTextObject_11">
	<div class="text-tab-content"  id="imFooter_imTextObject_11_tab0" style="">
		<div class="text-inner">
			<div><span class="fs14 cf1 ff1">© OZIMAP PCS GROUP 2021</span></div>
		</div>
	</div>
